    ...
    view! {
        <PageShell>
            <div class="flex flex-col gap-4 items-center py-8 w-full">
                <div class="text-xl font-semibold text-slate-800">"Motion"</div>
                ...
                <MotionDiv
                    ...
                    initial=MotionStyle::new().opacity(0.0).y(32.0).scale(0.94)
                ...
                >
                    <div class="p-6 text-left">
                        <div class="text-lg font-semibold text-slate-900">"Leptos Motion"</div>
