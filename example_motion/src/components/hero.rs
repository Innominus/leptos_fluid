use leptos::prelude::*;
use leptos_fluid::motion::{Easing, MotionButton, MotionDiv, MotionStyle, Transition};
        ...
        <section class="hero">
            <div class="panel">
                ...
                <div class="button-row">
                    <button on:click=move |_| { hero_toggle.update(|val| *val = !*val) }>
                    ...
                    <button
                        class="alt"
                        on:click=move |_| card_focus.update(|val| *val = !*val)
                    >
                        {move || {
                            if card_focus.get() { "Unfocus cards" } else { "Focus cards" }
                        }}
                    </button>
                </div>
            </div>
